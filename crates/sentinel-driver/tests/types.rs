...
fn types_dump_params_var_call() {
    ...
    assert_eq!(
        ...
        "(fn #14 add ((param #0 a i64) (param #1 b i64)) i64 \
...
fn types_dump_let_inference() {
    ...
    assert_eq!(
        ...
        "(fn #14 main () i64 (block (let #0 i64 (int 5 :i64)) \
...
fn types_dump_struct_lit_and_field() {
    ...
    assert_eq!(
        ...
        "(struct #0 Box (field v i64))\n\
         (fn #14 main () i64 (block (let #0 Box (struct-lit #0 Box (int 42 :i64) :Box)) \
...
fn types_dump_nullable_widen() {
    ...
    assert_eq!(
        ...
        "(fn #14 main () i64 (block (let #0 ?i64 (widen-null (int 42 :i64) :?i64)) \
...
fn types_dump_method_dispatch() {
    ...
    assert_eq!(
        ...
        "(class #0 Counter (field n i64) \
         ...
         (fn #14 main () i64 (block (let #0 Counter (class-init #0 Counter (int 7 :i64) :Counter)) \
