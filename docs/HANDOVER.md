...
### ▶ RESUME HERE (2026-06-30 — ADR 0066 M2.4 DONE (real pipe transport + variable-length records + argv) + GENERIC word-scalar in-process channels → NEXT: the worker-pool library (blocked on closures) / Mutex / scg mirror — maintainer's call)
