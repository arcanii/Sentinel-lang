...
### ▶ RESUME HERE (2026-06-30 — ADR 0066 **M2.4 REAL PIPE TRANSPORT DONE**: an authenticated cross-process `SealedChannel<secret i64>` runs end-to-end over a process pipe → NEXT: M2.4c (generic `secret T`) or the scg mirror)
