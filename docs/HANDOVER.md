...
### ▶ RESUME HERE (2026-06-30 — ADR 0066 M2.4 DONE through the real pipe transport + variable-length `secret [u8]` records + argv reflection → NEXT: M2.4c-2 (generic word-scalar `Type::SealedChannel`) or the scg mirror)
