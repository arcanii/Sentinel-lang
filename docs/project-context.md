...
- The callable ABI is **`abi-v1`** and is **stable at 1.0** — no breaking changes to emitted symbol names/shapes. Cross-module / separate-compilation linking relies on module-qualified `abi-v1` symbols.
